...
public class PrintTask extends SIRTask {
    ...
    protected boolean execute(CommandSender sender, String[] args) {
        ...
        var catcher = new TargetCatcher(sender, args.length > 1 ? args[1] : null);
        ...
        if (args[0].matches("(?i)ACTION-BAR")) {
            ...
            var hasArg = args[2].matches("(?i)DEFAULT|CENTERED|MIXED");
    ...
    protected List<String> complete(CommandSender sender, String[] args) {
        ...
        if (args.length == 2) {
            ...
            var l = Lists.newArrayList("@a", "PERM:", "WORLD:");
    ...
    class Printer {
        ...
        private void print(String key) {
            ...
            for (var player : catcher.targets) {
                var k = MessageKey.matchKey(key);

                if (k == MessageKey.CHAT_KEY) {
                    var a = SIRPlugin.getUtils().splitLine(message);
                    ...
                    var d = SIRPlugin.getUtils().getKeysDelimiters();
